...
import { URLSearchParams , Http, Headers, Request, RequestOptions, RequestOptionsArgs, RequestMethod, Response } from '@angular/http';
...
export class AuthHttp {
  ...
  private mergeOptions(providedOpts: RequestOptionsArgs, defaultOpts?: RequestOptions) {
    ...
    let result = newOptions.merge(new RequestOptions(providedOpts));
    result.search = <URLSearchParams>providedOpts.search;
    return result;
  }
  ...
  private requestHelper(requestArgs: RequestOptionsArgs, additionalOptions?: RequestOptionsArgs): Observable<Response> {
    ...
    if (additionalOptions) {
      //options.search = <URLSearchParams>additionalOptions.search;
      let newOptions = options.merge(additionalOptions);
      newOptions.search = <URLSearchParams>additionalOptions.search;
      return this.request(new Request(this.mergeOptions(newOptions, this.defOpts)));
    }
  ...
  public get(url: string, options?: RequestOptionsArgs): Observable<Response> {
    return this.requestHelper({ body: '', method: RequestMethod.Get, url: url, search:options.search, params:options.search }, options);
  }
